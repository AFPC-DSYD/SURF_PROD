...
__WEBPACK_IMPORTED_MODULE_8__router__["a" /* default */].beforeEach(function (to, from, next) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_19__store_store__["a" /* store */].state.sanity != check_portal) {
    var querystring = __webpack_require__("1nuA");
    var formData = {
      _PROGRAM:  false ? "/REN - Dashboard Home V1/makeHTML" : "/WebApps/SURF/surf",
      nPage: "sanity"
    };
    var myData = __WEBPACK_IMPORTED_MODULE_9_axios___default.a.post(axios_url_surf, querystring.stringify(formData)).then(function (response) {
      ...
      if (mySanity != 'INSANE') {
        window.location.href =  false ? 'https://starsraw.afpc.randolph.af.mil' : 'https://stars.afpc.randolph.af.mil';
      } else {
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
  routes: [{
    path: '/',
    name: 'Surf',
    component:  false ? Surf : __WEBPACK_IMPORTED_MODULE_5__components_SurfFla__["a" /* default */]
  }, {
    path: '/Surf_CIP',
    name: 'Surf_CIP',
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            [
              _c("div", { staticClass: "row" }, [
                (_vm.process.env.NODE_ENV === "production"
                ? (_vm.surfTitle = "SURF")
                : (_vm.surfTitle = "SURF FLA"))
                  ? _c("h1", { staticClass: "col" }, [
                      _vm._v("  " + _vm._s(_vm.surfTitle) + " ")
                    ])
                  : _vm._e(),
                _vm._v(" "),
                _c(
...
//# sourceMappingURL=app.a9d180ee31a7b6fc0465.js.map